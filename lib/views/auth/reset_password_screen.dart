                  ...
                  Padding(
                    ...
                    child: RichText(
                      ...
                      text: TextSpan(children: [
                        TextSpan(
                            text:
                                'An email has bees sent to your account\'s email address ${email}. Please check your email to continue',
                            style: TextStyle(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: GoogleFonts.inter(
                            fontWeight: FontWeight.w500, color: kColorPrimary),
                      ),
                      SizedBox(height: 10),
                      title('Email'),
                      buildEmailFormField(),
                            ...
                            if (_formKey.currentState!.validate()) {
                              ...
                              await auth
                                ...
                                Fluttertoast.showToast(
                                    msg:
                                        "Something went to wrong. Please try with your register email.",
